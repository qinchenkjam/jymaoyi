<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./template/mobile/new/service\index.html";i:1495175313;s:31:"./template/mobile/new/base.html";i:1495176304;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
...
<div id="wrapper">
 ...
 <div class="urHere">position：<?php echo $serveTitle; ?></div> <div class="treeBox">
 ...
 <?php if(is_array($serveList) || $serveList instanceof \think\Collection || $serveList instanceof \think\Paginator): $i = 0; $__LIST__ = $serveList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>  
      <dl>
    <dd>
    <p class="img"><a onclick="hits(<?php echo $vo['id']; ?>);" href="<?php echo url('mobile/CaseServe/detail',['id'=>$vo['id']]); ?>"><img src="<?php echo UPLODS; ?><?php echo $vo['image']; ?>" width="135" height="135" /></p>
