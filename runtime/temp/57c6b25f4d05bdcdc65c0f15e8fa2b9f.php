<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\wamp\www\jymaoyi./application/admin\view\user\login.html";i:1494486165;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
  ...
  <img src="<?php echo captcha_src(); ?>"  onclick="refreshVerify()" id="verify_img" > <a href="javascript:refreshVerify()">换一张</a> </div>
      ...
      <div class="row cl">
       ...
       <input name="" type="button" class="btn btn-success radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;" onclick="checkLogin()">
          <input name="" type="reset" class="btn btn-default radius size-L" value="&nbsp;取&nbsp;&nbsp;&nbsp;&nbsp;消&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo url('admin/user/tomail'); ?>">忘记密码</a>
        </div>
      </div>
    </form>
  </div>
