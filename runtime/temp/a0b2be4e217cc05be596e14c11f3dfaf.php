<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:40:"./application/admin\view\user\login.html";i:1494915241;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
  ...
  <img src="<?php echo captcha_src(); ?>"  onclick="refreshVerify()" id="verify_img" > <a href="javascript:refreshVerify()">换一张</a> </div>
      ...
      <div class="row cl">
       ...
       <input name="" type="button" class="btn btn-success radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;" onclick="checkLogin()">
          <input name="" type="reset" class="btn btn-default radius size-L" value="&nbsp;取&nbsp;&nbsp;&nbsp;&nbsp;消&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo url('admin/user/tomail'); ?>">忘记密码</a><br/><br/>
          <p>请使用火狐,谷歌,猎豹，360浏览器访问</p>         
        </div>
      </div>
    </form>
  </div>
</div>
<div class="footer">Copyright 广州金缘美容用品有限公司 </div>
