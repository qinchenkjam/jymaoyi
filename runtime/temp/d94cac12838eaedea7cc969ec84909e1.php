<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./template/pc/default/article\detail.html";i:1495073757;s:31:"./template/pc/default/base.html";i:1494559496;}*/ ?>
...
<div id="main">
		<div id="mainLeft">
                ...
                <li class="cat-item cat-item-18"><a href="<?php echo url('index/article/lists',['cat_id'=>$vo['cat_id']]); ?>" class=""><?php echo $vo['cat_name']; ?></a></li>
		...
		<div id="ny_mainRight">
				...
				<div class="ny_main">
						...
						<div class="title"><span class="right">Position: Homt &gt; <?php echo substr($msg['title'],0,10); ?>..</a></span><?php echo substr($msg['title'],0,25); ?>..</div>
<div class="content">
...
previous:
<?php else: ?>
<a href="<?php echo url('index/Article/detail',['id'=>$prveId]); ?>"><?php echo $relateData['prev']['title']; ?></a>
<?php endif; ?>
</span> 
&nbsp; &nbsp;
<span>
...
next:&nbsp;
<?php else: ?>
<a href="<?php echo url('index/Article/detail',['id'=>$nextId]); ?>"><?php echo $relateData['next']['title']; ?></a>
<?php endif; ?>
</span>
								<p>&nbsp;</p>															
						<div class="clear"></div>
