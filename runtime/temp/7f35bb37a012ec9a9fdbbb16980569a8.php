<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\wamp\www\jymaoyi./application/admin\view\service\index.html";i:1494472756;s:62:"D:\wamp\www\jymaoyi./application/admin\view\public\layout.html";i:1494569249;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div style="">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 服务案例 <span class="c-gray en">&gt;</span> 案例列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="page-container">

		
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="form_del_data()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" data-title="添加资讯" _href="<?php echo url('admin/CaseServe/add'); ?>" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加案例</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
		<div class="mt-20">
		<form name="form" method="post" action="<?php echo url('Admin/CaseServe/del'); ?>">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
					<tr class="text-c va-m">
						...
						<td class="text-l"><a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><?php echo substr($vo['name'],0,21); ?></a></td>
						<td class="text-l"><?php echo substr($vo['desc'],0,21); ?></td>
						<td><?php echo date("Y-m-d",$vo['add_time']); ?></td>
						<td class="td-status"><span class="label label-success radius">已发布</span></td>
						<td class="td-manage"><a style="text-decoration:none" class="ml-5"  href="edit?id=<?php echo $vo['id']; ?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
