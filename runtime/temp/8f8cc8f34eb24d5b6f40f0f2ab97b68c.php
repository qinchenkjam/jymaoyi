<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./application/admin\view\index\index.html";i:1494840567;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="<?php echo url("","",true,false);?>">后台管理</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v2.4</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
				...
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							...
							<li><a href="javascript:;" onclick="picture_add('添加幻灯片','banner_add.html')"><i class="Hui-iconfont">&#xe613;</i> 图片</a></li>
							<li><a href="javascript:;" onclick="product_add('添加产品','product_add.html')"><i class="Hui-iconfont">&#xe620;</i> 产品</a></li>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				...
				<ul class="cl">
			<li><a href="<?php echo url('admin/Index/clear_cache'); ?>" >清除缓存</a></li>
				  <li>  <a href="<?php echo url('index/index/index'); ?>" target="_blank">网站首页</a></li>
					<li>超级管理员</li>
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">admin <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="<?php echo url('admin/Admin/changePassword'); ?>">修改密码</a></li>
							<!-- <li><a href="#">切换账户</a></li> -->
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo url('admin/CaseServe/index'); ?>" data-title="服务案例" href="javascript:void(0)">服务案例</a></li>
				</ul>
			</dd>
		</dl>
		<!-- <dl id="menu-comments">
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo url('admin/Template/index'); ?>?t=pc"  data-title="系统设置" href="javascript:void(0)">PC模板设置</a></li> 
