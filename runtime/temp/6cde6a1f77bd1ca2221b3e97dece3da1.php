<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./template/pc/default/service\index.html";i:1494553088;s:31:"./template/pc/default/base.html";i:1494559496;}*/ ?>
...
<div id="main">
	...
	<li class="cat-item cat-item-18">没有分类目录</li>
		...
		<div id="ny_mainRight">
				...
				<div class="ny_main">
						...
						<div class="title"><span class="right">Position: Home &gt; <?php echo $serveTitle; ?></span> <?php echo $serveTitle; ?></div>
						<div class="content">
		<ul class="pro_ul">	
 <?php if(is_array($serveList) || $serveList instanceof \think\Collection || $serveList instanceof \think\Paginator): $i = 0; $__LIST__ = $serveList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>								
<li>
<a onclick="hits(<?php echo $vo['id']; ?>);" href="<?php echo url('index/CaseServe/detail',['id'=>$vo['id']]); ?>"><img src="<?php echo UPLODS; ?><?php echo $vo['image']; ?>" /><?php echo substr($vo['name'],0,21); ?>...</a>
</li>
...
/* $(function(){
 ...
 function hits(id){
    //alert(id);
    //var id;
    $.getJSON("<?php echo url('admin/CaseServe/updateHits'); ?>",{'id':id},function(res){
