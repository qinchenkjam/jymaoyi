<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin\view\admin\admin_add.html";i:1494485852;s:43:"./application/admin\view\public\layout.html";i:1494841434;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="save" method="post"  onsubmit="return check(this)">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" placeholder="@" name="email" id="email" style="width:70%" value="<?php echo $msg['email']; ?>">
		</div>
	</div>
	<div class="row cl">
